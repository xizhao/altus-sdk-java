...
public class WorkloadAnalyticsConfiguration  {
  ...
  /**
   * Whether Altus Workload Analytics integration is enabled.
   **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WorkloadAnalyticsConfiguration workloadAnalyticsConfiguration = (WorkloadAnalyticsConfiguration) o;
    if (!Objects.equals(this.enable, workloadAnalyticsConfiguration.enable)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkloadAnalyticsConfiguration {\n");
