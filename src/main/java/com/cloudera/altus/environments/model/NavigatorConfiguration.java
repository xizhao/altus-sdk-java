...
import com.cloudera.altus.environments.model.NavigatorConfigurationAwsDetails;
...
public class NavigatorConfiguration  {
   ...
   * 
   **/
  private NavigatorConfigurationAwsDetails awsDetails = null;
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NavigatorConfiguration navigatorConfiguration = (NavigatorConfiguration) o;
    if (!Objects.equals(this.enable, navigatorConfiguration.enable)) {
      return false;
    }
    if (!Objects.equals(this.awsDetails, navigatorConfiguration.awsDetails)) {
      return false;
    }
    return true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enable, awsDetails);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NavigatorConfiguration {\n");
