...
/**
 * Class used to report well-formed errors from Altus services.
 */
public class AltusServiceException extends AltusHTTPException {
   ...
   * @param statusCode the Altus status code
   * @param statusMessage the Altus status message
   */
  public AltusServiceException(String requestId,
                               int httpCode,
