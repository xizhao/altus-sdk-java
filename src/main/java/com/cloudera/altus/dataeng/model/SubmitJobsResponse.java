...
public class SubmitJobsResponse extends AltusResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubmitJobsResponse submitJobsResponse = (SubmitJobsResponse) o;
    if (!Objects.equals(this.jobs, submitJobsResponse.jobs)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(jobs, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubmitJobsResponse {\n");
