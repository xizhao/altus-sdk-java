...
public class CreateAWSClusterResponse extends AltusResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (!Objects.equals(this.clouderaManagerUsername, createAWSClusterResponse.clouderaManagerUsername)) {
      return false;
    }
    if (!Objects.equals(this.clouderaManagerPassword, createAWSClusterResponse.clouderaManagerPassword)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
