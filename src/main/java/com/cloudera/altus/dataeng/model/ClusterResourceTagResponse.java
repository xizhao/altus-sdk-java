...
public class ClusterResourceTagResponse extends AltusResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClusterResourceTagResponse clusterResourceTagResponse = (ClusterResourceTagResponse) o;
    if (!Objects.equals(this.key, clusterResourceTagResponse.key)) {
      return false;
    }
    if (!Objects.equals(this.value, clusterResourceTagResponse.value)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class ClusterResourceTagResponse {\n");
