...
public class ListMachineUserAssignedRolesResponse extends AltusResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListMachineUserAssignedRolesResponse listMachineUserAssignedRolesResponse = (ListMachineUserAssignedRolesResponse) o;
    if (!Objects.equals(this.roleCrns, listMachineUserAssignedRolesResponse.roleCrns)) {
      return false;
    }
    if (!Objects.equals(this.nextToken, listMachineUserAssignedRolesResponse.nextToken)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class ListMachineUserAssignedRolesResponse {\n");
