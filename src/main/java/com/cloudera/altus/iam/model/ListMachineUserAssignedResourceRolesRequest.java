...
public class ListMachineUserAssignedResourceRolesRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListMachineUserAssignedResourceRolesRequest listMachineUserAssignedResourceRolesRequest = (ListMachineUserAssignedResourceRolesRequest) o;
    if (!Objects.equals(this.machineUserName, listMachineUserAssignedResourceRolesRequest.machineUserName)) {
      return false;
    }
    if (!Objects.equals(this.pageSize, listMachineUserAssignedResourceRolesRequest.pageSize)) {
      return false;
    }
    if (!Objects.equals(this.startingToken, listMachineUserAssignedResourceRolesRequest.startingToken)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class ListMachineUserAssignedResourceRolesRequest {\n");
