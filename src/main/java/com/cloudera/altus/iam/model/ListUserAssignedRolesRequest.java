...
public class ListUserAssignedRolesRequest  {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListUserAssignedRolesRequest listUserAssignedRolesRequest = (ListUserAssignedRolesRequest) o;
    if (!Objects.equals(this.user, listUserAssignedRolesRequest.user)) {
      return false;
    }
    if (!Objects.equals(this.pageSize, listUserAssignedRolesRequest.pageSize)) {
      return false;
    }
    if (!Objects.equals(this.startingToken, listUserAssignedRolesRequest.startingToken)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    ...
    sb.append("class ListUserAssignedRolesRequest {\n");
