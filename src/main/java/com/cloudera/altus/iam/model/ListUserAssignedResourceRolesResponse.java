...
public class ListUserAssignedResourceRolesResponse extends AltusResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListUserAssignedResourceRolesResponse listUserAssignedResourceRolesResponse = (ListUserAssignedResourceRolesResponse) o;
    if (!Objects.equals(this.resourceAssignments, listUserAssignedResourceRolesResponse.resourceAssignments)) {
      return false;
    }
    if (!Objects.equals(this.nextToken, listUserAssignedResourceRolesResponse.nextToken)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public String toString() {
    ...
    sb.append("class ListUserAssignedResourceRolesResponse {\n");
